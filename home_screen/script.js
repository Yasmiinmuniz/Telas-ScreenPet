...
function getActiveDay(date) {
    ...
    const dayName = getDayNameInPortuguese(day.getDay());
...
//permite 50 caracteres no título do evento
addEventTitle.addEventListener("input", (e) => {
    addEventTitle.value = addEventTitle.value.slice(0, 60);
});


//permite apenas o tempo no horário do evento
...
addEventTo.addEventListener("input", (e) => {
    addEventTo.value = addEventTo.value.slice(0, 100);
});
...
addEventSubmit.addEventListener("click", () => {
    ...
    //verifica o formato correto da hora 24 horas
...
function getEvents() {
    //verifique se os eventos já estão salvos no armazenamento local e retorne o evento, caso contrário, nada
